...
! function (e, define) {
    ...
    return function (e, t) {
        ...
        function i(e) {
            var t = f.culture().numberFormat[w];
            return e = ("" + e).replace(w, t)
        }

        function r(e, t) {
            return e instanceof Date ? e = t ? f.stringify(e).replace(/"/g, "") : f.format("{0:G}", e) : "number" == typeof e && (e = i(e)), e
        }

        function o(e, n, i, o, l, c) {
            v(n) ? s(e, n, l, c) : _(n) ? a(e, n, l, c) : e[l] === t && (e[l] = i[o] = r(n, c))
        }
        ...
        function s(e, t, n, i) {
            var r, a, s, l, c;
            for (r = 0, a = 0; t.length > r; r++) s = t[r], l = "[" + a + "]", c = n + l, o(e, s, t, l, c, i), a++
        }
        ...
        function l(n, i) {
            return n.filters ? e.map(n.filters, function (e) {
                var t = e.filters && e.filters.length > 1,
                    n = l(e, i);
                return n && t && (n = "(" + n + ")"), n
            }).join("~" + n.logic + "~") : n.field ? n.field + "~" + n.operator + "~" + c(n.value, i) : t
        }

        function c(e, t) {
            if ("string" == typeof e) {
                if (!(e.indexOf("Date(") > -1)) return e = e.replace(g, "''"), t && (e = encodeURIComponent(e)), "'" + e + "'";
        ...
        function d(n) {
            return {
                ...
                items: n.HasSubgroups ? e.map(n.Items || n.items, d) : n.Items || n.items
            }
        }
        ...
        function p(e) {
            var t, n, i, r = {};
            for (t = 0, n = e.length; n > t; t++) i = e[t], r[i.Member] = m(!0, r[i.Member], u(i));
            return r
        }
        var f = window.kendo,
            g = /'/gi,
        ...
        m(!0, f.data, {
            ...
            transports: {
                "aspnetmvc-ajax": f.data.RemoteTransport.extend({
                    init: function (e) {
                        var t = this,
                            i = (e || {}).stringifyDates;
                        f.data.RemoteTransport.fn.init.call(this, m(!0, {}, this.options, e, {
                    ...
                    read: function (e) {
                        ...
                        _(t) ? (n && (this.options.data = null), !t.Data.length && n ? f.data.RemoteTransport.fn.read.call(this, e) : e.success(t)) : f.data.RemoteTransport.fn.read.call(this, e)
                    },
                    options: {
                        read: {
                            type: "POST"
            ...
            schemas: {
                webapi: f.data.schemas["aspnetmvc-ajax"]
            }
        }), m(!0, f.data, {
            transports: {
                webapi: f.data.RemoteTransport.extend({
                    init: function (e) {
                        var t, i, r = this,
                            o = (e || {}).stringifyDates;
                        e.update && (t = "string" == typeof e.update ? e.update : e.update.url, e.update = m(e.update, {
                            url: function (n) {
                                return f.format(t, n[e.idField])
                            }
                        })), e.destroy && (i = "string" == typeof e.destroy ? e.destroy : e.destroy.url, e.destroy = m(e.destroy, {
                            url: function (t) {
                                return f.format(i, t[e.idField])
                            }
            ...
            transports: {
                "aspnetmvc-server": f.data.RemoteTransport.extend({
                    init: function (e) {
                        var t = this;
                        f.data.RemoteTransport.fn.init.call(this, m(e, {
        ...
        function (e) {
            ...
            function o(e) {
                var t, n, i, r, o = {},
                    ...
                    s = e.FieldName,
                    d = e.ValidationRules;
                for (i = 0, r = d.length; r > i; i++) t = d[i].ValidationType, n = d[i].ValidationParameters, o[s + t] = c(s, t, n), a[s + t] = l(d[i].ErrorMessage);
                return {
                    rules: o,
                    messages: a
                }
            ...
            var u = /("|\%|'|\[|\]|\$|\.|\,|\:|\;|\+|\*|\&|\!|\#|\(|\)|<|>|\=|\?|\@|\^|\{|\}|\~|\/|\||`)/g,
                h = {
                    required: function (e) {
                        ...
                        return o.length && (t = o[0].name.replace(u, "\\$1"), n = "input:hidden[name='" + t + "']", i = o.next(n), i.length || (i = o.next("label.k-checkbox-label").next(n)), r = i.length ? i.val() : "checked" === e.attr("checked")), !("" === r || !r)
                    },
                    number: function (e) {
