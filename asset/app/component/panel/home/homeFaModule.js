(function () {
    "use strict";
    angular
        .module('homeFa', ['ngMaterial', 'ngMessages', 'material.svgAssetsCache', 'easypiechart', 'md.data.table', 'perfect_scrollbar'])
        .config(routeconfig);
    ...
    function routeconfig($stateProvider) {
        ...
        $stateProvider.state('panel_fa.home', {
            url: '/home',
            templateUrl: "asset/app/component/panel/home/homefa.tpl.html"
        });
    }
    angular
        .module('homeFa')
        .controller('homeFaCtrl', function ($scope, $http, $interval, $state, $localStorage) {
                        ...
                        Highcharts.stockChart('stockchart-home', {
                            ...
                            xAxis: {
                                ...
                                labels: {
                                    formatter: function () {
                                        moment.loadPersian()
                                        return moment(this.value).format("jMMMM jD , HH:mm");
                                    }
                                }
                            },
                            ...
                            for (var prop1 in tempContractType) {
                                ...
                                if (flagExistDiscretionary[contractLoop]) {
                                    assetAllocationObj = {
                                        ...
                                        'name': tempContractType[prop1].AssetAllocation.AssetTitleFa,
                                        'y': tempContractType[prop1].AssetAllocation.NetValue,
                                        'drilldown': tempContractType[prop1].AssetAllocation.AssetTitleFa
                                    };
                                }
                                ...
                                for (var prop2 in tempContractType[prop1].AssetAllocations) {
                                    if (flagExistDiscretionary[contractLoop]) {
                                        datatempObj = {
                                            'name': tempContractType[prop1].AssetAllocations[prop2].AssetTitleFa,
                                ...
                                if (flagExistDiscretionary[contractLoop]) {
                                    seriesTempObj = {
                                        'name': tempContractType[prop1].AssetAllocation.AssetTitleFa,
                                        'id': tempContractType[prop1].AssetAllocation.AssetTitleFa,
                                        'data': datatempArr
                                    };
                                }
