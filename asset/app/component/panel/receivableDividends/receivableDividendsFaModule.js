...
(function () {
    "use strict";
    angular
        .module('receivableDividendsFa', ['kendo.directives', 'ngMaterial', 'ngMessages', 'material.svgAssetsCache'])
        .config(routeconfig);

    function routeconfig($stateProvider) {
        $stateProvider.state('panel_fa.receivableDividends', {
            url: '/receivableDividends',
            templateUrl: "asset/app/component/panel/receivableDividends/receivableDividendsFa.tpl.html",
            controller: 'receivableDividendsFaCtrl'
        });
    }

    angular
        .module('receivableDividendsFa')
    ...
    angular
        .module('receivableDividendsFa')
        .controller('receivableDividendsFaCtrl', function ($scope, $state, $timeout) {

            $scope.unreceivedCashDividendListDatePickerTo = moment(new Date()).add(-1, 'days').format('jYYYY/jMM/jDD');
                    ...
                    $("#receivableDividendsGrid1").kendoGrid({
                        ...
                        dataSource: {
                                        ...
                                        data: {
                                            ReportFilter: {
                                                ...
                                                "DateFilter": {
                                                    ...
                                                    "EndDate": moment($scope.unreceivedCashDividendListDatePickerTo, 'jYYYY/jMM/jDD').format('YYYY-MM-DD')
                                                },
                                                "ContractType": 5
                                            },
                            ...
                            schema: {
                                ...
                                model: {
                                    id: "CurrentId",
                                    fields: {
                                        ProductNameEn: { field: "ProductNameFa", editable: false, validation: { required: true } },
                                        ProductSymbolEn: { field: "ProductSymbolFa", editable: false },
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                title: $scope.content.EventDate,
                                template: "#= CurrentCorporateActionDate == null ? '' : moment(kendo.toString(kendo.parseDate(CurrentCorporateActionDate, 'yyyy-MM-dd'), 'yyyy-MM-dd'), 'YYYY-M-D').format('jYYYY/jM/jD') #"
                            },
                            {
                                field: "StockAmount",
                            ...
                            },
                            {
                                ...
                                width: "200px",
                                //template: "#= TransactionDate == null ? '' : moment(kendo.toString(kendo.parseDate(TransactionDate, 'yyyy-MM-dd'), 'yyyy-MM-dd'), 'YYYY-M-D').format('jYYYY/jM/jD') #",
                            ...
                            { command: ["ویرایش"], title: "&nbsp;", width: "250px" }
                        ]
                    });
                        ...
                        success: function (result) {
                            ...
                            for (var prop1 in result.Result) {
                                ...
                                unreceivedCashDividendObj = {
                                    'name': result.Result[prop1].ProductNameFa,
