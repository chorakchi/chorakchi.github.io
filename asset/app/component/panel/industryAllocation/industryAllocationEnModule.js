(function () {
    "use strict";
    angular
        .module('industryAllocationEn', [])
        .config(routeconfig);

    function routeconfig($stateProvider) {
        $stateProvider.state('panel_en.industryAllocation', {
            url: '/industryAllocation',
            templateUrl: "asset/app/component/panel/industryAllocation/industryAllocationEn.tpl.html"
        });
    }
    angular
        .module('industryAllocationEn')
    ...
    angular
        .module('industryAllocationEn')
        .controller('industryAllocationEnCtrl', function ($scope, $http, $state, $timeout) {
            $scope.ManagementTypeCode = '0';
            $scope.industryAllocationDate = moment(new Date()).add(-1, 'days').format('YYYY-MM-DD');
            ...
            $scope.industryAllocationReportEnGenerate = function () {
                ...
                var filter = {
                    ...
                    "Date": $scope.industryAllocationDate
                };
                $("#industryAllocationGrid1").kendoGrid({
                    toolbar: ["excel"],
                    excel: {
                        text: "test",
                        fileName: "IndustryAllocationEn.xlsx",
